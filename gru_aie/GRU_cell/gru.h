...
class gru : public adf::graph {
    ...
    adf::port<adf::input> r_hidden_initialization[H_VECTOR_SIZE/DIST_COEFF];
    adf::port<adf::input> Wr_params[H_VECTOR_SIZE/DIST_COEFF];
    adf::port<adf::input> Ur_params[H_VECTOR_SIZE/DIST_COEFF];
    adf::port<adf::input> br_params[H_VECTOR_SIZE/DIST_COEFF];
